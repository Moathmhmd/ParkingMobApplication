                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context,
                            '/user_info'); // Navigate to User Info page
                      },
                      child: CircleAvatar(
                        radius: 40,
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (filteredParkingSpots.isEmpty) {
                        return const Center(
                            child: Text('No matching parking spots found.'));
                      }
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ParkingCard(
                            imageUrl:
                                'assets/onboarding1.png', // Placeholder image
                            name: spot['name'] ?? 'Unnamed Spot',
                            location: spot['area'] ??
                                'Unknown Area', // Display area from Firestore
